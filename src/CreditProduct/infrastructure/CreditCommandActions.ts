...
export class CreditCommandActions {
    constructor (private service: ICreditProductInput, private thumbnail:string="credit") {}
    ...
    add = async (interaction: ChatInputCommandInteraction) => {
        try {
            ...
            if (!amount) throw new CreditProductAmountNotProvidedError()
            ...
            const credit = new CreditProduct({
                price:price, 
                amount:amount,
                media:media,
                codec:codec,
